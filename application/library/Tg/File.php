...
class Tg_File
{
	...
	public function __construct() 
	{
		...
		$this->_defaultConfig['storageFolder'] = STORAGE_PATH."/uploads";
		$this->_defaultConfig['tempFolder'] = STORAGE_PATH."/tmp";
		$this->_defaultConfig['cacheFolder'] = PUBLIC_PATH."/file";
		...
		$this->_cacheFolder = realpath($this->_config['cacheFolder']);
