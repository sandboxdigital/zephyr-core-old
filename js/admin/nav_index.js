...
(function (Ext,Tg){
    ...
    //
        ...
        var doublePanel = new Tg.DoublePanel (navTree, contentPanel, o);
    ...
    Ext.ux.form.TreeCombo = Ext.extend(Ext.form.TriggerField, {
        ...
        setValueToTree: function () {
            ...
            this.fireEvent('change',this.value, this.currentNode);
