...
$.fn.inPageForm = function(options) 
{
	inPageForms.push(new InpageController (this, options));
...
function InpageController(elements, settings) 
{
	this.init(elements, settings);
}

$.extend(InpageController.prototype, {
	container : '',
	overlay : '',
	settings : {},
	autoClose : true,
