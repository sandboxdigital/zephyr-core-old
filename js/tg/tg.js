...
* @author Chris Scott
*/
Tg.App = Ext.extend(Ext.util.Observable, {
	constructor: function (config) {
	    ...
	    Tg.App.superclass.constructor.apply(this, arguments);
	},
    ...
    */
    ...
    initStateProvider: function () {
        ...
        */
        var days = 7;        // expires when browser closes
        var date = new Date();
    ...
    */
    registerActions: function (actions) {
        Tg.Apply(this.api.actions, actions);
    },
